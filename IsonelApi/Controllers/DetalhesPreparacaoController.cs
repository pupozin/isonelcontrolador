...
namespace IsonelApi.Controllers
{
    ...
    public class DetalhesPreparacaoController : ControllerBase
    {
        ...
        public IActionResult AdicionarDetalhes([FromBody] DetalhesPreparacaoCreateDto dto)
        {
            ...
            if (etapa == null)
            {
                return NotFound("Etapa nao encontrada.");
            }
            ...
            return Ok(new
            {
                message = "Detalhes de preparacao adicionados com sucesso!",
                detalhes.Id,
        ...
        public IActionResult AtualizarDetalhes(int id, [FromBody] DetalhesPreparacaoUpdateDto dto)
        {
            ...
            if (detalhes == null)
            {
                return NotFound("Detalhes de preparacao nao encontrados.");
            }
            ...
            {
                detalhes.Comprimento = dto.Comprimento;
            }

            if (dto.Largura > 0)
            {
                detalhes.Largura = dto.Largura;
            }

            if (dto.Altura > 0)
            {
                detalhes.Altura = dto.Altura;
            }

            if (dto.Espessura > 0)
            {
                detalhes.Espessura = dto.Espessura;
            }

            if (dto.Quantidade > 0)
            {
                detalhes.Quantidade = dto.Quantidade;
            }
            ...
            return Ok(new
            {
                message = "Detalhes de preparacao atualizados com sucesso!",
                detalhes.Id,
                detalhes.TipoMaterial,
                detalhes.Quantidade
            });
